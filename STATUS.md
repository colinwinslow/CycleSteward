...
**Last updated:** 2026-07-03 (probe CC/CV disambiguation implemented — packet 5 / F7 done; 302 offline tests green; arch + BDD reviews OK)
**Phase:** Phase 2 - HA adapter
**Next bounded packet:** Manual-override semantics (F8). Needs a small ADR/spec note first: what the switch means, whether it dispatches TURN_ON, and detection of external plug-on so cutoff + guardrails apply (ADR-0009 promise).
**Current readiness:** READY-FOR-NEXT-PACKET (packet 5 complete, verified, reviewed)
